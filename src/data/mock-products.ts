...
export const testimonials = [
  {
    ...
    content: "The quality of the handcrafted items is exceptional. Each piece tells a unique story and adds character to my clients' homes.",
  ...
  },
  {
    ...
    name: "Michael Chen",
    role: "Art Collector",
    content: "I'm impressed by the authenticity and attention to detail in every product. The cultural significance behind each item makes them truly special.",
  ...
  },
  {
    ...
    content: "These souvenirs bring back wonderful memories of my travels. The packaging and presentation are always perfect for gifting.",
